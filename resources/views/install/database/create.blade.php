<x-layouts.install>
    ...
    <x-slot name="content">
        <div class="grid sm:grid-cols-6 gap-x-8 gap-y-4 my-3.5">
            ...
            <x-form.group.text name="prefix" label="{{ trans('install.database.prefix') }}" value="{{ old('prefix', $prefix) }}" not-required form-group-class="sm:col-span-6" />
        </div>
    </x-slot>
</x-layouts.install>
